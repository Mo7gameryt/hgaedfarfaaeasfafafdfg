...
-----------------------------------------------------------------
!#invites - يقول لك كم واحد دخل من رابط الانفايت حقك
-----------------------------------------------------------------
...
-----------------------------------------------------------------
!#profile - لمعرفة معلومات عنك على هيئة صورة
-----------------------------------------------------------------
...
client.on('message', message => {
    ...
    .then(invites => message.channel.send(```You Just Invite [${invites.find(invite => invite.inviter.id === message.author.id).uses}] On This Server!```))
...
client.on('message', message => {
 ...
 client.on('message', message => {
    if(message.content == ('!#profile')) {
             ...
             if (message.channel.type === 'chat') return message.reply('This Command Is Not Avaible In Dm\'s :x:');
...
if(member.voiceChannelID === '466980004962500649') {
...
deny: ['CONNECT']
    ...
    const parent = member.guild.channels.get('466980004962500649').parentID
